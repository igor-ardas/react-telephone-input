    ...
    getCountryDropDownList: function getCountryDropDownList() {
        ...
        var countryDropDownList = map([].concat(_toConsumableArray(this.state.preferredCountries), _toConsumableArray(this.props.onlyCountries)), function (country, index) {
            ...
            return React.createElement(
                ...
                React.createElement('div', { className: inputFlagClasses, style: context.getFlagStyle() }),
                React.createElement(
                    'span',
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    { ref: function (c) {
                        ...
                        }, onClick: this.handleFlagDropdownClick, className: 'selected-flag', title: this.state.selectedCountry.name + ': + ' + this.state.selectedCountry.dialCode },
                    React.createElement(
                        'div',
